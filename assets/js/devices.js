        ...
        return `
            <tr data-id="${device.id}" class="border-b border-slate-700 hover:bg-slate-800/50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    ...
                    <a href="/map?map_id=${device.map_id}&edit_device_id=${device.id}" data-navigo class="text-yellow-400 hover:text-yellow-300 mr-3" title="Edit Device"><i class="fas fa-edit"></i></a>
