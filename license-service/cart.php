...
if (isset($_POST['add_to_cart']) && isset($_POST['product_id'])) {
    ...
    if ($product) {
        if (isset($_SESSION['cart'][$product_id])) {
            ...
            $message = '<div class="alert-error mb-4">Product is already in your cart.</div>';
        } else {
            ...
            $message = '<div class="alert-success mb-4">Product added to cart!</div>';
        }
    } else {
        $message = '<div class="alert-error mb-4">Product not found.</div>';
    }
}
...
if (isset($_POST['remove_from_cart']) && isset($_POST['product_id'])) {
    ...
    if (isset($_SESSION['cart'][$product_id])) {
        ...
        $message = '<div class="alert-success mb-4">Product removed from cart.</div>';
    }
}
...
<?php if (empty($cart_items)): ?>
    <div class="card text-center py-8">
        ...
        <a href="products.php" class="btn-secondary mt-4">Continue Shopping</a>
    </div>
<?php else: ?>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="card flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Price: $<?= htmlspecialchars(number_format($item['price'], 2)) ?></p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-4">
                        <span class="text-lg font-bold">$<?= htmlspecialchars(number_format($item['price'] * $item['quantity'], 2)) ?></span>
        ...
        <div class="lg:col-span-1 card">
            ...
            <a href="payment.php" class="btn-primary w-full text-center">Proceed to Checkout</a>
        </div>
    </div>
<?php endif; ?>
