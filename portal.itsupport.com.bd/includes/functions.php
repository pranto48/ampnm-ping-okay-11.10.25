...
function admin_header($title = "Admin Panel") {
    ...
    <body class="admin-body flex flex-col min-h-screen">
        <nav class="admin-navbar py-4 shadow-md sticky top-0 z-50">
            <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
                <a href="index.php" class="text-2xl font-bold text-blue-400 mb-3 md:mb-0">
                    <i class="fas fa-user-shield mr-2"></i>Admin Panel
                </a>
                <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">';
    
    if (isAdminLoggedIn()) {
        // Admin Icon Dropdown Menu
        echo '<div class="relative group">
                <button class="admin-nav-link flex items-center space-x-2">
                    <i class="fas fa-user-shield text-lg"></i>
                    <span class="hidden md:inline">' . htmlspecialchars($_SESSION['admin_username']) . '</span>
                    <i class="fas fa-chevron-down text-xs ml-1 transition-transform duration-200 group-hover:rotate-180"></i>
                </button>
                <div class="absolute right-0 mt-2 w-48 bg-slate-800/90 backdrop-blur-lg border border-slate-700 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                    <a href="index.php" class="block px-4 py-2 text-sm text-gray-200 hover:bg-slate-700 rounded-t-lg"><i class="fas fa-tachometer-alt mr-2"></i> Dashboard</a>
                    <a href="orders.php" class="block px-4 py-2 text-sm text-gray-200 hover:bg-slate-700"><i class="fas fa-shopping-bag mr-2"></i> Orders</a>
                    <a href="users.php" class="block px-4 py-2 text-sm text-gray-200 hover:bg-slate-700"><i class="fas fa-users mr-2"></i> Customers</a>
                    <a href="license-manager.php" class="block px-4 py-2 text-sm text-gray-200 hover:bg-slate-700"><i class="fas fa-ticket-alt mr-2"></i> Licenses</a>
                    <a href="products.php" class="block px-4 py-2 text-sm text-gray-200 hover:bg-slate-700"><i class="fas fa-box-open mr-2"></i> Products</a>
                    <a href="tickets.php" class="block px-4 py-2 text-sm text-gray-200 hover:bg-slate-700"><i class="fas fa-headset mr-2"></i> Tickets</a>
                    <a href="smtp_settings.php" class="block px-4 py-2 text-sm text-gray-200 hover:bg-slate-700"><i class="fas fa-envelope mr-2"></i> SMTP Settings</a>
                    <div class="border-t border-slate-700 my-1"></div>
                    <a href="change_password.php" class="block px-4 py-2 text-sm text-gray-200 hover:bg-slate-700"><i class="fas fa-key mr-2"></i> Change Password</a>
                    <a href="../logout.php?admin=true" class="block px-4 py-2 text-sm text-red-400 hover:bg-red-900/30 rounded-b-lg"><i class="fas fa-sign-out-alt mr-2"></i> Logout</a>
                </div>
            </div>';
    } else {
