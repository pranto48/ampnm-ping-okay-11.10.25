...
$licenseActions = ['get_licenses', 'create_license', 'update_license', 'delete_license']; // New license actions
...
} elseif (in_array($action, $licenseActions)) { // New handler for licenses
