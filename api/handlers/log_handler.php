...
switch ($action) {
    ...
    case 'get_detailed_status_logs':
        ...
        switch ($period) {
            case 'live': $interval = 'INTERVAL 1 HOUR'; break;
            case '7d': $interval = 'INTERVAL 7 DAY'; break;
            case '30d': $interval = 'INTERVAL 30 DAY'; break;
            case '24h': default: $interval = 'INTERVAL 24 HOUR'; break;
        }

        $sql = "
            SELECT
                l.id, l.old_status, l.status, l.details, l.created_at,
